            ...
            <div class="row">
                                ...
                                @foreach($categorie as $cat)
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <a href="{{ asset("/produse/".$cat->adr_url) }}">
                                                {{ $cat->denumire }}
                                            </a>
                                        </h4>
                                    </div>
                                            ...
                                            <ul>
                                                @foreach($subcategorie as $subcat)
                                                    @if($subcat->id_parinte==$cat->id)
                                                        <li><a id="list"
                                                               href="{{ asset("produse/subcategorie/".$subcat->adr_url) }}">{{ $subcat->denumire }}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            </ul>
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($furnizori as $furnizor)
                                        <li>
                                            <a href="{{ asset('/furnizor/produse/'.$furnizor->id) }}">{{ $furnizor->denumire_furnizor }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        <h2 class="title text-center">{{ $subcategorieSelectata->denumire }}</h2>
                        ...
                        @foreach($produseSubcategorie as $produs)
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <a href="{{ asset('produs/'.$produs->id)}}"
                                                   class="btndetalii btn-detalii">Vezi
                                                    detalii</a>
