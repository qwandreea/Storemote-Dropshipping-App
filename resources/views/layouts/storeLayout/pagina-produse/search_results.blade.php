            ...
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        ...
                        @if($count === 0)
                            <h1> <b style="color: #886f4a">{{ $count }}</b> rezultate pentru <b style="color: #886f4a">{{ $query }}</b> </h1>
                        @else
                            <h1><b style="color: #886f4a">{{$count}}</b> rezultate gasite pentru <b style="color: #886f4a"> {{ $query }} </b> :</h1>
                        @endif


                        @foreach($rezultat as $produs)
