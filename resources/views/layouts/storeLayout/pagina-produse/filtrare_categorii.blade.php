            ...
            <div class="row">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($furnizori as $furnizor)
                                        <li><a href="{{ asset('/furnizor/produse/'.$furnizor->id) }}">{{ $furnizor->denumire_furnizor }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        <h2 class="title text-center">{{ $categorieSelectata->denumire }}</h2>
                        ...
                        @foreach($producteCategorieSelectata as $produs)
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{ asset('/uploads/produse/'.$produs->imagine) }}"
                                                     alt="Imagine produs"/>
                                                <a href="{{ asset('produs/'.$produs->id)}}" class="btndetalii btn-detalii">Vezi
                                                    detalii</a>
